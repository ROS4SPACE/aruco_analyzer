...
def generate_single_marker(dictionary_name, ar_id, length=500, margin=0):
...
def generate_grid(dictionary_name, first_ar_id, x, y, length, separation, margin=0, border_bits=1):
    dictionary = cv2.aruco.getPredefinedDictionary(dictionary_name)
